...
namespace LevelEditor
{
    public partial class MainForm : Form
    {
        ...
        private void listView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (itemtype == "file")
            {
                var spriteSheet = (SpriteSheet)listView1.Tag;
                var tex = GetBrushData(spriteSheet.SpriteDef[listView1.FocusedItem.Name].SrcRectangle, spriteSheet.Texture);

                Instance.picturebox.createTextureBrush(tex, spriteSheet, listView1.FocusedItem.Name);
            }
