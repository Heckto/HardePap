...
{ 
    public class Hit : IHit
    {
        public Hit()
        {
            this.Normal = Vector2f.Zero;
            this.Amount = 1.0f;
        }

        public IShape Box { get; set; }
        ...
        public static IHit Resolve(Vector2f origin, Vector2f destination, IBox other)
        {
            var result = Resolve(origin, destination, other.Bounds);
            if (result != null) result.Box = other;
            return result;
        ...
        public static Hit Resolve(Vector2f origin, Vector2f destination, RectangleF other)
        {
        ...
        public static IHit Resolve(Vector2f point, IBox other)
        {
        ...
        public bool IsNearest(IHit than, Vector2f origin)
        {
