...
namespace AuxLib.CollisionDetection
{
    ...
    public interface IWorld
    {
        ...
        IHit Hit(RectangleF origin, RectangleF destination, MoveableBody box, IEnumerable<IShape> ignoring = null);
        ...
        IMovement Simulate(MoveableBody box, float x, float y, Func<ICollision, ICollisionResponse> filter, List<IShape> ignoreList = null);
