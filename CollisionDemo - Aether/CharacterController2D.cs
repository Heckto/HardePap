...
namespace Game666
{
    public class Controller2D : RaycastController
    {
        ...
        bool fallThrough;
        public Controller2D(Body body, World world,Category collisionMask) : base(body,world,collisionMask)
        {            
            collisions.faceDirection = 1;
        }

        public void Move(Vector2 moveAmount, bool fallThrough = false,bool standingOnPlatform = false)
        {
