...
namespace Game666
{
    public class RaycastController
    {
        ...
        protected readonly float skinWidth = ConvertUnits.ToSimUnits(.015f);
        ...
        public RaycastController(Body body, World _world, Category _collisionMask)
        {
        ...
        protected void UpdateRaycastOrigins()
        {
            ...
            var bounds = (ConvertUnits.ToSimUnits(((ControlledEntity)collider.Tag).colliderSize));
        ...
        {
            var bounds = ((ControlledEntity)collider.Tag).colliderSize;
