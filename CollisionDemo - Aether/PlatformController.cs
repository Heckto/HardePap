...
namespace Game666
{
    public class PlatformController : RaycastController
    {
        ...
        public PlatformController(Body body, World world, Category collisionMask) : base(body, world, collisionMask)
        {
        ...
        void MovePassengers(bool beforeMovePlatform)
        {
            foreach (var passenger in passengerMovement)
            {
                ...
                {
                    passengerDictionary.Add(passenger.fixture, ((Player)passenger.fixture.Body.Tag).controller);
                }

                if (passenger.moveBeforePlatform == beforeMovePlatform)
                {
                    passengerDictionary[passenger.fixture].Move(ConvertUnits.ToDisplayUnits(passenger.velocity),false,passenger.standingOnPlatform);
                }
            }
        }
