...
namespace Game1.CollisionDetection
{
    ...
    public interface IWorld
    {
        ...
        IPolyLine CreatePolyLine(Vector2[] points);
        ...
        IHit Hit(Vector2 point, IEnumerable<IShape> ignoring = null);
        ...
        /// <param name="ignoring">A collection of boxes that will be ignored during hit test (optionnal).</param>
        IHit Hit(Vector2 origin, Vector2 destination, IEnumerable<IShape> ignoring = null);
